...
# !pip install XaI-Ensemble-VOCs-API==0.4.3
...
text_result, main_sensors, main_fungi =  main.get_result_summary(df_caounts,base_dir+'/src/MappingVOC_DB.db',api.QUERY_FUNGI, api.QUERY_SENSOR)
